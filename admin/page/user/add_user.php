...
<div class="flex min-h-screen">
        ...
        <?php require "layout/header.php"?>
            ...
            <form action="index.php?ctl=add_new_user" method="post" class="flex flex-wrap w-3/5">
                <label class="mt-5 w-1/2 block font-medium" for="">ID
                <input class="block h-8 w-4/5 border rounded-lg mt-2 pl-2" type="text" value="Auto Number" readonly>
                </label>
