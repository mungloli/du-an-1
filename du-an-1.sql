...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 23, 2023 lúc 05:34 AM
...
INSERT INTO `gio_hang` (`id`, `id_khach_hang`, `id_san_pham`, `so_luong`, `id_dt`) VALUES
(16, 3, 8, 1, 2);
...
(11, 'Sicily EDP', 'Nước hoa Mancera Sicily EDP  là một mùi hương của sự vui tươi, hạnh phúc. Hương thơm của Sicily không đại trà, không dễ bị lẫn vào đám đông nhốn nháo các mùi hương khác, hoàn toàn vượt mặt đàn anh Credat Boise dù nó im lìm và không được quảng cáo rầm rộ.', 0, 3, 7),
(12, 'De Nuit Imperial For Women EDP', 'Mùi của những quả vải chín mọng đầy ngọt ngào lại được hòa cùng những cánh hoa hồng Thổ Nhĩ Kỳ đầy uyển chuyển và vani ngọt ấm. Với một mùi hương ngọt ngào như Club De Nuit Iimperiale EDP chắc chắn sẽ khiến mỗi nơi bạn bước qua đều để lại một dấu ấn riêng', 0, 2, 8),
(13, 'Do So EDP ', 'Đây sẽ là một chai nước hoa xứng đáng được đứng dầu danh sách cho những ai có niềm đam mê những chai nước hoa có mùi hương chủ đạo về hoa huệ. Hương thơm trong Do Son sẽ nữ tính, gần gũi và ngập tràn ánh nắng, màu sắc sẽ tươi sáng như hình ảnh bãi biển Đồ', 0, 2, 7),
(14, 'Margiela Replica Whispers in the Library EDT', 'Nước hoa Replica Whispers in the Library khiến người ta mường tượng tới những cuốn sách cổ cũ và hiếm trong một thư viện cổ nhuốm màu bụi thời gian. Tay với lên những kệ sách, mùi gỗ sáp thoang thoảng vờn qua mũi. Lật những quyển sách trên kệ, mùi da thuộ', 0, 3, 11),
(15, 'De Marly Herod EDP', 'Nước hoa nam hương thuốc lá Herod không đơn thuần chỉ là một chai nước hoa, Herod tựa như một bộ suit khoác trên mình một người đàn ông trưởng thành với thần thái và khí chất ngút ngàn. Đây sẽ là một kiểu mùi thuốc lá chỉ dành cho những ai thật sự có sự t', 0, 1, 6),
(17, 'Jacobs Daisy EauSo Fresh EDT', 'Không ngừng lại ở vẻ ngoài điệu đà, nữ tính, nước hoa Marc Jacobs Daisy Eau So Fresh mang đến một sự kết hợp đầy hoàn hảo giữa hương thơm hoa cỏ và trái cây vừa đậm đà, vừa thuần tuý như đưa Nàng đến một khu vườn cổ tích rợp sắc hương.', 0, 2, 11),
(18, 'DoveAmber', 'Trong một biển các mùi hương theo phong cách Hoa Hồng - Trầm Hương Rose Aoud, chắc chắn một điều, Roja Dove Amber Aoud là mùi hương được hoàn thiện chắc tay, vui thú, chất lượng, giá trị nhất và hoàn toàn xứng đáng để sưu tầm.', 0, 2, 2),
(19, 'Apogee EDP', 'Nước hoa nữ LV Apogée được đánh giá là một trong 3 mùi bán chạy nhất trong bộ sưu tập mới nhất Les Parfums của thương hiệu Louis Vuitton, hương thơm mở ra những khía cạnh nữ tính, thuần khiết và tinh tế hơn trong nét đẹp của phụ nữ.', 0, 2, 3),
(20, 'Hilfiger Boy EDT', 'Nước hoa Tommy Hilfiger sẽ mang đến một sự hấp dẫn khó có thể chối từ với hương thơm tươi mới, trẻ trung năng động nên rất phù hợp với những chàng trai trẻ.', 0, 1, 6),
(21, 'Paris Black Gold EDP', 'Nước hoa nam Mancera Paris Black Gold EDP là một trong số những tầng hương đem đến sự tao nhã, thanh lịch dành cho các quý ông muốn khẳng định bản thân mình, muốn tìm kiếm sự độc tôn và khác biệt.', 0, 1, 7),
(22, 'Ani Extrait De Parfum', 'Nước hoa unisex Nishane Ani Extrait De Parfum tạo ấn tượng ngay từ những giây phút đầu tiên vì những nốt hương quá tinh tế.', 0, 3, 5),
(23, 'Fuel For Lief EDT', 'Nước hoa nam Diesel Fuel For Life EDT là một mùi hương tuyệt vời dùng khi các quý ông tham gia các hoạt động sôi nổi như đi vũ trường. Đặc biệt hương vị của chai nước hoa cao cấp này có thể dùng vào tất cả các mùa trong năm và trong mọi sự kiện, chắc chắn', 0, 1, 9),
